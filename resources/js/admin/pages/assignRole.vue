         ...
         <!--~~~~~~~ TABLE ONE ~~~~~~~~~-->
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Role Management
                          <Select v-model="data.id"  style="width:300px"  placeholder="select admintype" @on-change="changeAdmin" >
						...
						<table class="_table">
                            ...
                            <div class="center_button">
                               <Button type="primary"
                                ...
                                :loading="isSending" :disabled="isSending" @click="assignRoles">Assign</Button>
                            </div>
						</table>
					</div>
				</div>
...
export default {
    ...
    methods:{
        async assignRoles(){
            ...
            if(res.status==200){
                this.s('Role assigned successfuly')
