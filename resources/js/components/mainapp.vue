            ...
            <ul class="_1side_menu_list_ul">
             ...
             <!-- <li ><router-link to="tags"><Icon type="ios-speedometer" />Tags</router-link></li>
              <li ><router-link to="category"><Icon type="ios-speedometer" />Category</router-link></li>
                ...
                <li ><router-link to="role"><Icon type="ios-speedometer" />Rolemanagement</router-link></li> 
                 <li ><router-link to="assign"><Icon type="ios-speedometer" />Assign Role</router-link></li> 
                <li ><router-link to="/logout"><Icon type="ios-speedometer" />Logout</router-link></li>
